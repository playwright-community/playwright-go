...
// RejectOnEvent sets the Waiter to return an error when an event occurs (and the predicate is true)
...
// WaitForEvent sets the Waiter to return when an event occurs (and the predicate is true)
